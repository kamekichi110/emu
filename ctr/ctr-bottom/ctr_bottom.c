      ...
      else if ( ctr_bottom_state.mode == MODE_SAVESTATE )
      {
                  ...
                  T_Y < 200 && !KeyHeld )
         {
            ...
            if (save_to_ram)
            {
               ...
               runloop_msg_queue_push("Saving state to RAM", 1, 256, false, NULL, MESSAGE_QUEUE_ICON_DEFAULT, MESSAGE_QUEUE_CATEGORY_INFO); /* todo: add MSG_HASH */
                  ...
                  T_Y < 200 && !KeyHeld )
         {
			...
			{
               runloop_msg_queue_push("Loading state from RAM", 1, 256, false, NULL, MESSAGE_QUEUE_ICON_DEFAULT, MESSAGE_QUEUE_CATEGORY_INFO); /* todo: add MSG_HASH */

...
#ifdef _3DS
DEFAULT_TITLE_MACRO(action_get_menu_3ds_settings_list,          MENU_ENUM_LABEL_VALUE_MENU_3DS_SETTINGS)
#endif
...
#ifdef _3DS
      {MENU_ENUM_LABEL_DEFERRED_MENU_3DS_SETTINGS_LIST,               action_get_menu_3ds_settings_list},
#endif

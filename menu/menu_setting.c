...
#ifdef _3DS
static void setting_get_string_representation_uint_video_ctr_display_mode(
      rarch_setting_t *setting,
      char *s, size_t len)
{
   if (!setting)
...
static void setting_get_string_representation_uint_ctr_bottom_display_mode(
      rarch_setting_t *setting,
      char *s, size_t len)
{
   if (!setting)
...
static void setting_get_string_representation_uint_video_ctr_render_target(
      rarch_setting_t *setting,
      char *s, size_t len)
{
   if (!setting)
...
static void setting_get_string_representation_uint_input_ctr_mouse_mode(
      rarch_setting_t *setting,
      char *s, size_t len)
{
   if (!setting)

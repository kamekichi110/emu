...
enum msg_hash_enums
{
...
#ifdef _3DS
   MENU_LABEL(CTR_BOTTOM_LCD_ENABLE),
   
   MENU_LABEL(VIDEO_CTR_DISPLAY_MODE),
   MENU_ENUM_LABEL_VALUE_CTR_VIDEO_MODE_3D,
   MENU_ENUM_LABEL_VALUE_CTR_VIDEO_MODE_2D,
   MENU_ENUM_LABEL_VALUE_CTR_VIDEO_MODE_2D_400X240,
   MENU_ENUM_LABEL_VALUE_CTR_VIDEO_MODE_2D_800X240,

   MENU_LABEL(VIDEO_CTR_RENDER_TARGET),
   ...
   MENU_LABEL(VIDEO_CTR_DUAL_DEADZONE),
   MENU_LABEL(VIDEO_CTR_DUAL_OFFSET_X),
   MENU_LABEL(VIDEO_CTR_DUAL_OFFSET_Y),

   MENU_LABEL(INPUT_CTR_MOUSE_MODE),
   ...
   MENU_LABEL(INPUT_CTR_SENSORS_ENABLE),
   MENU_LABEL(INPUT_CTR_SENSORS_CURSOR),
   MENU_LABEL(INPUT_CTR_LIGHTGUN_ABS),

   MENU_LABEL(CTR_BOTTOM_DISPLAY_MODE),
   ...
   MENU_LABEL(CTR_BOTTOM_ASSETS_DIRECTORY),
   MENU_LABEL(CTR_BOTTOM_FONT_ENABLE),
   MENU_LABEL(CTR_BOTTOM_FONT_COLOR_RED),
   MENU_LABEL(CTR_BOTTOM_FONT_COLOR_GREEN),
   MENU_LABEL(CTR_BOTTOM_FONT_COLOR_BLUE),
   MENU_LABEL(CTR_BOTTOM_FONT_COLOR_OPACITY),
   MENU_LABEL(CTR_BOTTOM_FONT_SCALE),

   MENU_LABEL(CTR_BOTTOM_CONSOLE_ENABLE),
   MENU_LABEL(CTR_BOTTOM_DEBUG_ENABLE),
   MENU_LABEL(CTR_N3DS_SPEEDUP_ENABLE),
   MENU_LABEL(CTR_SAVE_STATE_TO_RAM),
#endif
